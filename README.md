...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opensearch-dsl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14722&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opensearch-dsl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opensearch-dsl` can be installed with:

```
conda install opensearch-dsl
```

It is possible to list all of the versions of `opensearch-dsl` available on your platform with:
